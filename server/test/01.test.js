...
const theHelpers = require('../src/controllers/helpers/getDriversFromDB')
...
describe("Routes test", () => {
  describe("GET| /drivers", () => {
    it("should return drivers", async () => {
      ...
      jest.spyOn(theHelpers,'getAllDriversFromDB').mockResolvedValue(driversMock);
      jest.spyOn(theHelpers,'getDriversFromDB').mockResolvedValue(driversMock);
